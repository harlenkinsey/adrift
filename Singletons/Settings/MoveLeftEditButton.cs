...
public partial class MoveLeftEditButton : Button
{
	SettingsManager SM;
	string State = "Idle";
	...
	public override void _Ready()
	{
		...
		SM.MoveLeftChanged += OnMoveLeftChanged;
	}
	...
	public void OnMoveLeftChanged(string value)
	{
		State = "Idle";
		Text = value;
